...
<head>
   ...
   <!-- site metas -->
   <title>Bienvenido a Union Agronegocios</title>
   <meta name="keywords" content="">
   <meta name="description" content="">
   <meta name="author" content="">
   <p>hola</p>
   <!-- site icon -->
   <link rel="icon" href="<?php echo base_url(); ?>adminlte/images/fevicon.png" type="image/png" />
   <!-- bootstrap css -->
   ...
   <!-- fancy box js -->
   <link rel="stylesheet" href="<?php echo base_url(); ?>adminlte/css/jquery.fancybox.css" />
   <!--[if lt IE 9]>
