<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>boos/css/bootstrap.css">
 ...
 <?php
foreach($infodogfit->result() as $row) 
 {
        echo form_open_multipart('Producto/modificardogfitbd');
 
    ?>
     <input type="hidden" name="idEspecial"  class="form-control" value="<?php echo $row->idEspecial;?>">
