<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>boos/css/bootstrap.css">
 ...
 <!-- Content Wrapper. Contains page content -->
        ...
        <div class="row">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <br>
                 <a href="<?php echo base_url(); ?>index.php/producto/agregarproveedor">
  ...
  <td> <?php echo form_open_multipart('producto/modificarproveedor'); ?>
   ...
   <td> <?php echo form_open_multipart('producto/eliminarproveedor'); ?>
       <input type="hidden" name="idProveedor" value="<?php echo $row->idProveedor; ?>">
